...
void RootSignature::CreateRootSignature(D3D12System& d3d12, ROOTTYPE type) {
	if (type == ROOTTYPE::Normal) {
		...
		D3D12_DESCRIPTOR_RANGE rangeT3[1] = {};
		rangeT3[0].BaseShaderRegister = 3; // t3 (EnvironmentLight)
		rangeT3[0].NumDescriptors = 1;
		rangeT3[0].RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
		rangeT3[0].OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND;
		...
		*/
		...
		// Environment Texture (t3)
		rootParameters[10].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;
		rootParameters[10].DescriptorTable.pDescriptorRanges = rangeT3;
